...
- Extension: `npm run dev` (Chrome), `npm run dev:firefox`, `npm run build`, `npm test`
- Server: `uv run uvicorn app.main:app --reload --port 8000`, `uv run pytest`
- Eval: `uv run python -m eval.run_all`
